...
import { FormRegistro } from "@/components/cuenta/form-registro";
import { BotonGoogle } from "@/components/cuenta/boton-google";
import { AuthPanel } from "@/components/cuenta/auth-panel";

export const metadata: Metadata = {
  title: "Crear cuenta · Tlachiwalis",
  description: "Crea tu cuenta para comprar artesanía mexicana directo del taller.",
};
    ...
    <div className="flex min-h-full flex-col">
      ...
      <main className="mx-auto grid w-full max-w-5xl flex-1 gap-12 px-6 pt-28 pb-16 md:grid-cols-2 md:items-stretch md:pt-32">
        <div className="mx-auto w-full max-w-md">
          ...
          <h1 className="mt-3 font-display text-4xl leading-tight sm:text-5xl">Crea tu cuenta</h1>
          <p className="mt-3 leading-relaxed text-ceniza">
            Para comprar y guardar tus piezas favoritas.
          </p>
