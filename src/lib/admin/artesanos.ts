...
const COLS =
  "id,slug,nombre,semblanza,region,oficio,foto_url,rfc,regimen_fiscal,clabe,status,user_id,created_at,updated_at,stripe_account_id,cobros_habilitados,cobros_detalles_enviados,nombres,apellido_paterno,apellido_materno,fecha_nacimiento,telefono,tipo_vendedor,nombre_negocio,num_personas,direccion,redes,envia_nacional,anios_experiencia";
